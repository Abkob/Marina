...
Return JSON only: {"verdict":"supported","reply":"the user-facing explanation of the pending proposal"} OR {"verdict":"clarify","reply":"one concise, natural question resolving the missing target or decision"}.
All changes are still pending proposals. For supported changes, always return a reply preserving the useful explanation while explicitly saying it is ready to review and apply. No records have been changed. In particular, "I’ve added", "marked complete", "created", "archived", and "done" are false completion claims here even when the user requested that operation. Describe what the proposal WILL do after Apply, never what you have already done.
