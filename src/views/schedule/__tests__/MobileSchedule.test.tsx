...
const openOptions = () => fireEvent.click(screen.getByRole('button', { name: 'Schedule options' }));
const chooseDay = () => { openOptions(); fireEvent.click(screen.getByRole('button', { name: 'Day' })); };
describe('phone calendar interactions', () => {
  ...
  it('keeps secondary tools off the main screen and makes empty routines reachable', () => {
    render(<MobileSchedule {...props()} renderRoutines={() => <button>Create native routine</button>} />);
